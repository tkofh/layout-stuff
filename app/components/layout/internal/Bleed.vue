...
@layer layout.init {
  [data-bleed] {
    ...
    @container style(--screen-gte-tablet: true) {
      ...
      --bleed-top-actual: max(var(--bleed-top-tablet, var(--bleed-y-actual)), 0px);
      --bleed-right-actual: max(var(--bleed-right-tablet, var(--bleed-x-actual)), 0px);
      --bleed-bottom-actual: max(var(--bleed-bottom-tablet, var(--bleed-y-actual)), 0px);
      --bleed-left-actual: max(var(--bleed-left-tablet, var(--bleed-x-actual)), 0px);
    }
    ...
    @container style(--screen-gte-laptop: true) {
      ...
      --bleed-top-actual: max(var(--bleed-top-laptop, var(--bleed-y-actual)), 0px);
      --bleed-right-actual: max(var(--bleed-right-laptop, var(--bleed-x-actual)), 0px);
      --bleed-bottom-actual: max(var(--bleed-bottom-laptop, var(--bleed-y-actual)), 0px);
      --bleed-left-actual: max(var(--bleed-left-laptop, var(--bleed-x-actual)), 0px);
    }
    ...
    @container style(--screen-eq-desktop: true) {
      ...
      --bleed-bottom-desktop: var(--bleed-bottom-laptop, var(--bleed-y-desktop));
      ...
      --bleed-top-actual: max(var(--bleed-top-desktop, var(--bleed-y-actual)), 0px);
      --bleed-right-actual: max(var(--bleed-right-desktop, var(--bleed-x-actual)), 0px);
      --bleed-bottom-actual: max(var(--bleed-bottom-desktop, var(--bleed-y-actual)), 0px);
      --bleed-left-actual: max(var(--bleed-left-desktop, var(--bleed-x-actual)), 0px);
    }
  }
}
...
@layer layout.trait {
  [data-bleed] {
    margin: calc(-1 * var(--bleed-top-actual)) calc(-1 * var(--bleed-right-actual))
      calc(-1 * var(--bleed-bottom-actual)) calc(-1 * var(--bleed-left-actual));

    &[data-sized] {
      --inline-size-adjustment: calc(var(--bleed-left-actual) + var(--bleed-right-actual));
      --block-size-adjustment: calc(var(--bleed-top-actual) + var(--bleed-bottom-actual));
    }
  }
}
</style>
