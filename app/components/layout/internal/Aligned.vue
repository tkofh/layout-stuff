...
export type AlignedVerticalAlignment<T = never> = ResponsiveValue<VerticalAlignment | T>
export type AlignedHorizontalAlignment<T = never> = ResponsiveValue<HorizontalAlignment | T>
