...
import InternalLayoutBleed, { type BleedProps } from '~/components/layout/internal/Bleed.vue'
...
<template>
  <LayoutSized :width :height :aspect :min-width :min-height :max-width :max-height>
    <LayoutFrame :frame :frame-y :frame-x :frame-top :frame-right :frame-bottom :frame-left>
      <LayoutBleed :bleed :bleed-y :bleed-x :bleed-top :bleed-right :bleed-bottom :bleed-left>
