...
export function hasProperty<const T extends object, const K extends PropertyKey>(
  value: T,
  key: K,
): value is AssertProperty<T, K> {
...
export function isArray<const T>(input: T): input is AssertExtract<T, ReadonlyArray<unknown>> {
